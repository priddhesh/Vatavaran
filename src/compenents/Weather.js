...
function Weather(props) {
  return (
      <div className={`d-flex flex-row mb-6 bg-${props.isday ? "secondary" : "dark"}  text-${props.isday ? "dark" : "white"} text-emphasis-info1`}>
          <div className='container p-1 mb-2 '>
              <div className="d-flex justify-content-around">
                <h2>{props.location},{props.region}</h2>
          ...
          <div className={`container text-center text-${props.isday ? "dark" : "white"}`}>
            <div className="row">
